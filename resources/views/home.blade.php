        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="site/img/carousel-1.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase">MELHOR GINÁSTICA</h5>
                            <h1 class="display-2 text-white text-uppercase mb-md-4">DESENVOLVA SEU CORPO FORTE COM GYMSTER
                ...
                <div class="carousel-item">
                    <img class="w-100" src="site/img/carousel-2.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase">MELHOR GINÁSTICA</h5>
                            <h1 class="display-2 text-white text-uppercase mb-md-4">AUMENTE SUA FORÇA COM NOSSOS TREINADORES
        ...
        <div class="row gx-5">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded" src="site/img/about.jpg" style="object-fit: cover;">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="mb-4">
                    <h5 class="text-primary text-uppercase">Sobre Nós</h5>
                    <h1 class="display-3 text-uppercase mb-0">Bem-vindo</h1>
                </div>
                <h4 class="text-body mb-4">Venha Treinar connosco e alcance o máximo do seu potencial! </h4>
    ...
    <div class="container-fluid p-0 my-5">
        <div class="row g-0">
            <div class="col-lg-6" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100" src="site/img/testimonial.jpg" style="object-fit: cover;">
                </div>
            </div>
                ...
                <div class="owl-carousel testimonial-carousel">
                    ...
                    <div class="testimonial-item">
                        <p class="fs-4 fw-normal text-light mb-4"><i
                            ...
                            et tempor diam tempor erat dolor rebum sit ipsum.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="site/img/testimonial-2.jpg" alt="">
                            <div class="ps-4">
                                <h5 class="text-uppercase text-light">Client Name</h5>
                                <span class="text-uppercase text-secondary">Profession</span>
                            </div>
